...
@OnlyIn(Dist.CLIENT)
public class IllagerCaptainModel<T extends IllagerCaptainEntity> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Pillaged.MOD_ID, "illager_captain"), "main");
    ...
    public IllagerCaptainModel(ModelPart root) {
        this.root = root;
